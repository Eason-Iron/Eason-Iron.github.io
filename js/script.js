...
(function () {
  ...
  const normalizeThemeMode = (mode) => (mode === "false" ? "false" : "true");
  const savedMode =
    localStorage.getItem("dark_mode") ||
    document.documentElement.getAttribute("data-theme-mode") ||
    "true";
  setTheme(normalizeThemeMode(savedMode));

  themeButton.addEventListener(
    "click",
    throttle(() => {
      const currentMode = normalizeThemeMode(localStorage.getItem("dark_mode"));
